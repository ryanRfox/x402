...
**YOU ARE IN: `x402/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/x402/` (rig root) or other directories
...
**Your mail address:** `x402/polecats/furiosa`
**Your rig:** x402
**Your Witness:** `x402/witness`
...
| Ask Witness for help | `gt mail send x402/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`x402/witness`) when:
...
```bash
gt mail send x402/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
